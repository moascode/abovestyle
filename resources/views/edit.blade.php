...
<div class="container">
    ...
    <form method="POST" action="/order/{{ $order->id }}">
            ...
            <div class="card w-50">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input name="name" type="text" class="form-control" id="inputName" value="{{$order->name }}" placeholder="Above Style">
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="row">
            <div class="card w-50">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input class="form-control" type="number" value="500" id="inputAdvPay" aria-describedby="aPayHelp">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input class="form-control" type="number" value="0" id="inputCod" aria-describedby="codHelp">
            ...
            <div class="card w-50">
                <h4 class="card-header">Revenue Summary</h4>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label col-form-label">Net profit</label>
                        <label class="col-sm-4 col-form-label col-form-label" id="displayPrice">BDT 0</label>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label col-form-label">Product expense</label>
                        <label class="col-sm-4 col-form-label col-form-label" id="displayPrice">BDT 0</label>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label col-form-label">Profit margin</label>
                        <label class="col-sm-4 col-form-label col-form-label" id="displayCharge">BDT 0</label>
                    </div>
                </div>
            </div>
